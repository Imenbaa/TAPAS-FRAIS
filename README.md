...
| Datasets             | Models            | WER rVad-NONnormaliz | WER (rVAD)       | WER (Silero) | WER (rVAD-myconf) |
|----------------------|-------------------|----------------------|------------------|--------------|-------------------|
| TAPAS-FRAIS-verified | HMM-TDNN (ester)  | 30.9%                | 27.95%, 27.13%   | /            | 24.59%            |
| TAPAS-FRAIS-verified | Conformer (ester) | 34.7%                | 34.09%, 25.92%   | 24.79%       | 23.62%            |
| TAPAS-FRAIS-verified | Conformer (cv)    | 29%                  | 26.97%, 24.63%   | **24.26%**   | 26.87%            |
  ------------------------------------------------------------------------------------------------------------------------
...
| Typaloc (PARK-8)  | W2vec2_VAD_chunk            |                |  34.45%   |             |
...
| Typaloc (CEREB-7) | w2v2_VAD_chunk              | %              | 34.66%     |                  |
...
| Typaloc (SLA-12)  | W2v2_VAD_chunk              | %               |   53.13% |                  |
...
| Typaloc (CTR-12)  | asr-wav2vec2-commonvoice-fr |                 |  14.80%  |                  |
...
| Datasets  | Models                   | WER(sans hesitation) | WER(Avec hesitation) | 
|-----------|--------------------------|----------------------|----------------------|
| HC        | W2VEC-VAD-chunk          | 15.80%               | **15.89%**           |                                   
| HC        | Whisper-large-VAD-chunk  | 25.07%               | 25.15%               |                                   
| HC        | Whisper-VAD-chunk        | 31.46%               | 31.48%               |                                   
| HC        | Conf (cv)                | 19.98%               | 21.37%               |                                   
| HC        | Conf (ester)             | 20.79%               | 20.34%               |                                   
| HC        | Hmm_tdnn                 | 18.35%               | 19.38%               |    

| Datasets | Models                  | WER(sans hesitation) | WER(Avec hesitation) |
|----------|-------------------------|---------------------|----------------------|
| PD       | W2VEC-VAD-chunk         | 24.18%              | **24.20%**           |                                   
| PD       | Whisper-large-VAD-chunk | 35.56%              | 35.59%               |                                   
| PD       | Whisper-VAD-chunk       | 39.13%              | 39.18%               |                                   
| PD       | Conf (cv)               | 30.40%              | 30.96%               |                                   
| PD       | Conf (ester)            | 30.58%              | 30.37%               |                                   
| PD       | Hmm-Tdnn                | 30.49%              | 31.08%               |                                   

| Datasets | Models                  | WER(sans hesitation) | WER(Avec hesitation) | 
|----------|-------------------------|----------------------|----------------------|
| MSA      | W2VEC-VAD-chunk         | 25.52%               | 27.27%               |                                   
| MSA      | Whisper-large-VAD-chunk | 34.61%               | 36.14%               |                                   
| MSA      | Whisper-VAD-chunk       | 35.22%               | 36.72%               |                                   
| MSA      | Conf (cv)               | 29.23%               | 30.85%               |                                   
| MSA      | conf (ester)            | 27.48%               | **25.66%**           |                                   
| MSA      | Hmm-tdnn                | 35.82%               | 37.28%               |
